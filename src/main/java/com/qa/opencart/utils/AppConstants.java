...
public class AppConstants {
	...
	public static final String RESULTS_PAGE_TITLE= "Search -";
	public static final String LOGIN_PAGE_FRACTION_URL="route=account/login";
	
	
	public static final String ACCOUNTS_PAGE_TITLE= "My Account";
	public static final String ACCOUNTS_PAGE_FRACTION_URL="route=account/account";	
	public static final List<String> EXP_ACCOUNTS_PAGE_HEADER_LIST= Arrays.asList("My Account", "My Orders", "My Affiliate Account","Newsletter");
